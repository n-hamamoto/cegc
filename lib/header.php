...
<base href="https://<?php echo $documentRoot ?>">

<script type="text/javascript" src="https://<?php echo $documentRoot ?>/js/jquery.min.js"></script>
<script type="text/javascript" src="https://<?php echo $documentRoot ?>/js/common.js"></script>
